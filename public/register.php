      ...
      <form action="#" class="register-form" id="register-form" method="post" novalidate>
        <div class="register-form-item">
          ...
          <div class="register-form-input-cont">
            <input type="text" class="register-form-item-input" name="first_name" id="first_name" minlength="3"
              required />
        ...
        <div class="register-form-item">
          ...
          <div class="register-form-input-cont">
            <input type="text" class="register-form-item-input" name="last_name" id="last_name" minlength="3"
              required />
        ...
        <div class="register-form-item">
          ...
          <div class="register-form-input-cont">
            <input type="date" class="register-form-item-input" name="date_of_birth" id="date_of_birth" required /><span
              class="error-message" id="date_of_birth_error"></span>
          </div>
        </div>
        <div class="register-form-item">
        ...
        <div class="register-form-item">
          ...
          <div class="register-form-input-cont">
            <input type="password" class="register-form-item-input" name="password" id="password" minlength="3"
              required />
        ...
        <div class="register-form-item">
          ...
          <div class="register-form-input-cont">
            <input type="password" class="register-form-item-input" name="confirm_password" id="confirm_password"
